...
| **UniProt Swiss-Prot** (`--prokka`) | ❌<br>Get from this annot_database/ in this repo | Yes | Prokka functional annotation | [uniprot.org](https://www.uniprot.org/downloads) | release 2017 | 134 MB, 273,877 sequences | The UniProt Consortium, *NAR* — [10.1093/nar/gkac1052](https://doi.org/10.1093/nar/gkac1052) |
